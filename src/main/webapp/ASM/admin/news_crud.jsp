...
<body>
    ...
    <nav class="nav-menu">
        <div class="container">
            ...
            <a href="${pageContext.request.contextPath}/admin/news" class="nav-link active">Tin tức</a>
    ...
    <div class="main-container">
        <div class="content">
            ...
            <div class="form-section">
                ...
                <form id="articleForm" action="${pageContext.request.contextPath}/admin/news" method="post" class="article-form">
